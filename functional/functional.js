...
var stringss = require('./to-function.js')
 ...
 */
exports.map = function(fn, sequence, object) {
 ...
 */
exports.select = function(fn, sequence, object) {
    fn = Function.toFunction(fn);
    var len = sequence.length,
        result = [];
    for (var i = 0; i < len; i++) {
 ...
 */
exports.foldr = function(fn, init, sequence, object) {
    fn = Function.toFunction(fn);
    var len = sequence.length,
        result = init;
    for (var i = len; --i >= 0; )
 ...
 * >> some('>10', [1,2,3]) -> false
 */
exports.some = function(fn, sequence, object) {
    fn = Function.toFunction(fn);
    var len = sequence.length,
        value = false;
    for (var i = 0; i < len; i++)
 ...
 * >> every('<10', [1,2,3]) -> true
 */
exports.every = function(fn, sequence, object) {
    fn = Function.toFunction(fn);
    var len = sequence.length,
        value = true;
    for (var i = 0; i < len; i++)
...
/**
  ...
  */
exports.lambda = function(object) {
 ...
 */
exports.invoke = function(methodName/*, arguments*/) {
 ...
 * >> until('>10', '2*')(1) -> 16
 */
exports.until = function(pred, fn) {
    fn = Function.toFunction(fn);
...
var _startRecordingMethodChanges = function(object) {
    var initialMethods = {};
...
var _attachMethodDelegates = function(methods) {
    for (var name in methods)
        exports[name] = exports[name] || (function(name) {
            var fn = methods[name];
            return function(object) {
...
__initalFunctionState = _startRecordingMethodChanges(Function.prototype);
 ...
 * define a function on Functional that delegates to it.
 */
_attachMethodDelegates(__initalFunctionState.getChangedMethods());
delete __initalFunctionState;


// In case to-function.js isn't loaded.
Function.toFunction = Function.toFunction || exports.K;
